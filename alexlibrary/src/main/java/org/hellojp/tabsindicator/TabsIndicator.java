...
public class TabsIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private int textBackgroundResId = R.drawable.hellojp_tabindicator_background_tab;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        //indicator line
        lineColor = ta.getColor(R.styleable.TabsIndicator_ti_lineColor, lineColor);
        lineMarginTab = ta.getDimensionPixelOffset(R.styleable.TabsIndicator_ti_lineMarginTab, lineMarginTab);
        lineHeight = ta.getDimensionPixelOffset(R.styleable.TabsIndicator_ti_lineHeight, lineHeight);
        linePosition = ta.getInt(R.styleable.TabsIndicator_ti_linePosition, 1);
        //tabs text
        textColor = ta.getColorStateList(R.styleable.TabsIndicator_ti_textColor);
        textSizeNormal = ta.getDimensionPixelOffset(R.styleable.TabsIndicator_ti_textSizeNormal, textSizeNormal);
        textSizeSelected = ta.getDimensionPixelOffset(R.styleable.TabsIndicator_ti_textSizeSelected, textSizeSelected);
        //divider between tabs
        hasDivider = ta.getBoolean(R.styleable.TabsIndicator_ti_hasDivider, hasDivider);
        dividerColor = ta.getColor(R.styleable.TabsIndicator_ti_dividerColor, dividerColor);
        dividerWidth = ta.getDimensionPixelOffset(R.styleable.TabsIndicator_ti_dividerWidth, dividerWidth);
        dividerVerticalMargin = ta.getDimensionPixelOffset(R.styleable.TabsIndicator_ti_dividerVerticalMargin, dividerVerticalMargin);
        textBackgroundResId = ta.getResourceId(R.styleable.TabsIndicator_ti_textBackgroundResId, textBackgroundResId);
        ta.recycle();
    }
