package org.alex.floatindicatorlayout;
...
public class FloatIndicatorLayout extends RelativeLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        LogUtil.e("捕获 = " + likeXY + " getAction = " + event.getAction());
        ...
        if (MotionEvent.ACTION_DOWN == event.getAction()) {
            ...
            if (Math.abs(distanceY) * 0.5 > Math.abs(distanceX)) {
                if (LikeXY.likeNo.equals(likeXY)) {
                    likeXY = LikeXY.likeY;
                }
            ...
            LogUtil.e("ACTION_UP = " + likeXY + " getAction = " + event.getAction());
        } else {
            LogUtil.e("else = " + likeXY + " getAction = " + event.getAction());
        }
        LogUtil.e("离开了 = " + likeXY + " getAction = " + event.getAction());
        lastY = event.getRawY();
        likeXY = LikeXY.likeNo;
        return super.dispatchTouchEvent(event);
    }
     ...
     * 手势滑动——X轴、Y轴，初始化
     */
    private static class LikeXY {
        /**
         * 初始化
         */
        public static String likeNo = "likeNo";
        /**
         * X轴方向表现明显
         */
        public static String likeX = "likeX";

        /* * Y轴方向表现明显
         */
        public static String likeY = "likeY";
    }
